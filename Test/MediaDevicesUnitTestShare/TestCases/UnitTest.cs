...
#pragma warning restore CS0618 
    ...
    public void PersistentUniqueIdTest()
    {
        ...
        var dir = device.GetFileSystemInfoFromPersistentUniqueId(this.FolderPersistentUniqueId!) as MediaDirectoryInfo;

        var file = device.GetFileSystemInfoFromPersistentUniqueId(this.FilePersistentUniqueId!) as MediaFileInfo;
        device.Disconnect();
