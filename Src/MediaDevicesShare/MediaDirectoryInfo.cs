...
public class MediaDirectoryInfo : MediaFileSystemInfo
{
    ...
    public MediaDirectoryInfo CreateSubdirectory(string path)
    {
        ...
        return mainWorker.CreateSubdirectory(this.mediaDevice, item, path);
    }
    ...
    {
        NotConnectedException.ThrowIfNotConnected(this.mediaDevice);
        return mainWorker.EnumerateDirectories(this.mediaDevice, this.item);
    }
    ...
    {
        NotConnectedException.ThrowIfNotConnected(this.mediaDevice);
        return mainWorker.EnumerateDirectories(this.mediaDevice, this.item, searchPattern, searchOption);
    ...
    {
        NotConnectedException.ThrowIfNotConnected(this.mediaDevice);
        return mainWorker.EnumerateFiles(this.mediaDevice, this.item);
    }
    ...
    {
        NotConnectedException.ThrowIfNotConnected(this.mediaDevice);
        return mainWorker.EnumerateFiles(this.mediaDevice, this.item, searchPattern, searchOption);
    }
    ...
    {
        NotConnectedException.ThrowIfNotConnected(this.mediaDevice);
        return mainWorker.EnumerateFileSystemInfos(this.mediaDevice, this.item);
    }
    ...
    {
        NotConnectedException.ThrowIfNotConnected(this.mediaDevice);
        return mainWorker.EnumerateFileSystemInfos(this.mediaDevice, this.item, searchPattern, searchOption);
    }
}
