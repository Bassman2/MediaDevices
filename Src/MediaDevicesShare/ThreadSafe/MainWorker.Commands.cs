...
//    {
//        return InvokeEnumerable<string>(() =>
//        {
...
//    //public void Supported(MediaDevice mediaDevice, string id)
//    //{
//    //    Invoke(() =>
//    //    {
...
//    public bool EjectStorage(MediaDevice mediaDevice, string path)
//    {
//        return Invoke(() =>
//        {
...
//    internal bool InternalEject(MediaDevice mediaDevice, string id)
//    {
//        return Invoke(() =>
//        {
//            Command cmd = Command.Create(WPD.COMMAND_STORAGE_EJECT);
...
//    public void FormatStorage(MediaDevice mediaDevice, string path)
//    {
//        Invoke(() =>
//        {
//            Item? item = Item.FindFolder(mediaDevice, path);
...
//    internal void Format(MediaDevice mediaDevice, string id)
//    {
//        Invoke(() =>
//        {
//            Command cmd = Command.Create(WPD.COMMAND_STORAGE_FORMAT);
...
//    public bool SendTextSMS(MediaDevice mediaDevice, string functionalObject, string recipient, string text)
//    {
//        return Invoke(() =>
//        {
...
//    public bool StillImageCaptureInitiate(MediaDevice mediaDevice, string functionalObject)
//    {
//        return Invoke(() =>
//        {
...
//        return Invoke(() => GetStorageInfoIntern(mediaDevice, storageObjectId));
//    }

//    public MediaStorageInfo? GetStorageInfoIntern(MediaDevice mediaDevice, string storageObjectId)
//    {
//        ArgumentNullException.ThrowIfNullOrEmpty(storageObjectId, nameof(storageObjectId));
