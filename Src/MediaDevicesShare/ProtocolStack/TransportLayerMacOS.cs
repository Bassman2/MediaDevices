...
internal partial class TransportLayerMacOS : ITransportLayer
{
    ...
    public bool WriteRawBytes(byte[] data)
        => LibUsbBulkTransfer(deviceHandle, BulkOutPipe, data, data.Length, out _, 1000) == 0;
    ...
    [LibraryImport("libusb-1.0.dylib", EntryPoint = "libusb_init")]
    private static partial int LibUsbInit(out IntPtr context);

    [LibraryImport("libusb-1.0.dylib", EntryPoint = "libusb_open_device_with_vid_pid")]
    private static partial IntPtr LibUsbOpenDeviceWithVidPid(IntPtr context, ushort vendorId, ushort productId);

    [LibraryImport("libusb-1.0.dylib", EntryPoint = "libusb_claim_interface")]
    private static partial int LibUsbClaimInterface(IntPtr devHandle, int interfaceNumber);

    [LibraryImport("libusb-1.0.dylib", EntryPoint = "libusb_bulk_transfer")]
    ...
    [LibraryImport("libusb-1.0.dylib", EntryPoint = "libusb_close")]
    private static partial void LibUsbClose(IntPtr devHandle);

    [LibraryImport("libusb-1.0.dylib", EntryPoint = "libusb_exit")]
