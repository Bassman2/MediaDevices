...
public enum FunctionalCategory
{
    ...
    /// <summary>
    /// Indicates this object encapsulates storage functionality on the mediaDevice 
    ...
    /// <summary>
    /// Indicates this object encapsulates still image capture functionality on the mediaDevice 
    ...
    /// <summary>
    /// Indicates this object encapsulates audio capture functionality on the mediaDevice 
    ...
    /// <summary>
    /// Indicates this object encapsulates video capture functionality on the mediaDevice 
    ...
    /// <summary>
    /// Indicates this object encapsulates SMS sending functionality on the mediaDevice 
    /// (not the receiving or saved SMS messages since those are represented as content objects on the mediaDevice)
    /// </summary>                     
    ...
    /// <summary>
    /// Indicates this object encapsulates network configuration functionality on the mediaDevice 
