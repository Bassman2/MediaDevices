...
public enum Commands : ulong
{
    ...
    /// and wishes to ensure that the object is saved to the mediaDevice. 
    /// </summary>
    ...
    /// <summary>
    /// receives a chunk of data from mediaDevice following WPD_COMMAND_MTP_EXT_EXECUTE_COMMAND_WITH_DATA_TO_READ.   
    /// </summary>
    [Key(0x4d545058, 0x1a2e, 0x4106, 0xa3, 0x57, 0x77, 0x1e, 0x8, 0x19, 0xfc, 0x56, 15)]
    MtpExtVendorReadData,

    /// <summary>
    /// sends a chunk of data to mediaDevice following WPD_COMMAND_MTP_EXT_EXECUTE_COMMAND_WITH_DATA_TO_WRITE.   
    /// </summary>
    [Key(0x4d545058, 0x1a2e, 0x4106, 0xa3, 0x57, 0x77, 0x1e, 0x8, 0x19, 0xfc, 0x56, 16)]
    MtpExtVendorWriteData,

    /// <summary>
    /// Completes a data transfer and read response from mediaDevice. The transfer is initiated by either 
