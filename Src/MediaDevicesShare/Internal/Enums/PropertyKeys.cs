...
internal enum PropertyKeys : ulong
{
    ...
    /// <summary>
    /// This property determines whether or not this object is intended to be understood by the mediaDevice, or whether it has been placed on the mediaDevice just for storage.
    ...
    /// <summary>
    /// Opaque string set by client to retain state between sessions without retaining a catalogue of connected mediaDevice content.
    ...
    /// <summary>
    /// Indicates the date and time the object was created on the mediaDevice.
    ...
    /// <summary>
    /// Indicates the date and time the object was modified on the mediaDevice.
