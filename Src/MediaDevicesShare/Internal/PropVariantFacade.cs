    ...
    public override string ToString()
    {
        switch (this.Value.vt)
        {
            case PropVariantType.VT_LPSTR:
                return Marshal.PtrToStringAnsi(this.Value.ptrVal) ?? string.Empty;

            case PropVariantType.VT_LPWSTR:
                return Marshal.PtrToStringUni(this.Value.ptrVal) ?? string.Empty;

            case PropVariantType.VT_BSTR:
                return Marshal.PtrToStringBSTR(this.Value.ptrVal) ?? string.Empty;
